...
Режим переключается автоматически по наличию этого блока внутри формы — класс `form-errors` тут только для стилей, работает именно атрибут
`data-form-errors`, его переименовывать нельзя.
